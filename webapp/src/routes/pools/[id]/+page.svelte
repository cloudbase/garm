				...
				<div class="px-4 py-5 sm:p-6">
					...
					<dl class="space-y-4">
						<div>
							...
							<dd class="mt-1 text-sm text-gray-900 dark:text-white">{pool.max_runners ?? 0}</dd>
						</div>
						<div>
							<dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Min Idle Runners</dt>
							<dd class="mt-1 text-sm text-gray-900 dark:text-white">{pool.min_idle_runners ?? 0}</dd>
						</div>
						<div>
							<dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Bootstrap Timeout</dt>
							<dd class="mt-1 text-sm text-gray-900 dark:text-white">{pool.runner_bootstrap_timeout ?? 20} minutes</dd>
						</div>
						<div>
